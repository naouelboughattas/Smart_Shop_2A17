...
void Produit::statistic(QCustomPlot *customPlot)
{
 ...
 //   regen->moveAbove(nuclear);
    ...
    query.prepare("SELECT COUNT(DISTINCT id_p) FROM produit where prix between 0 and 50");
    query.exec();
    int i;
    while(query.next())
    {
    ...
    query.prepare("SELECT COUNT(DISTINCT id_p) FROM produit where prix between 50 and 100");
    query.exec();
    int ii;
    while(query.next())
    {
    ...
    query.prepare("SELECT COUNT(DISTINCT id_p) FROM produit where prix between 100 and 1000");
    query.exec();
    int j;
    while(query.next())
    {
    ...
    query.prepare("SELECT COUNT(DISTINCT id_p) FROM produit where prix > 1000");
    query.exec();
    int k;
    while(query.next())
    {
