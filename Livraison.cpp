...
bool livraison::ajouter_livraison(){
    ...
    qry.exec("SELECT NOM_C,ADRESSE,TTC_F FROM FACTURES,CLIENTS where FACTURES.ID_C=CLIENTS.ID_CLIENT");
    qry.bindValue(":o",o);
...
QSqlQueryModel * livraison::afficher_livraison()
{
    ...
    model->setQuery("SELECT NOM_C,ADRESSE,TTC_F FROM FACTURES,CLIENT where FACTURES.ID_C=CLIENT.ID_CLIENT");
